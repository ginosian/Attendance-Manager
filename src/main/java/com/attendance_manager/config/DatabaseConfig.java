package com.attendance_manager.config;
...
@EnableJpaRepositories(basePackages = "com.attendance_manager")
...
//        properties.put("hibernate.import_files", import_files);
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource) {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.attendance_manager");
